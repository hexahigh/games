...
/**
 * Class: OpenLayers.Layer.OSM.HOT
 *
 * Inherits from:
 *  - <OpenLayers.Layer.OSM>
 */
OpenLayers.Layer.OSM.HOT = OpenLayers.Class(OpenLayers.Layer.OSM, {
    /**
     * Constructor: OpenLayers.Layer.OSM.HOT
     *
     * Parameters:
     * name - {String}
     * options - {Object} Hashtable of extra options to tag onto the layer
    ...
    initialize: function(name, options) {
        ...
        options = OpenLayers.Util.extend({
            numZoomLevels: 20,
            attribution: "&copy; contributeurs <a href='http://www.openstreetmap.org/copyright'>OpenStreetMap</a>, Tuiles courtoisie du <a href='http://hot.openstreetmap.org'>Groupe humanitaire HOT</a>",
            buffer: 0,
            transitionEffect: "resize"
        }, options);
        var newArguments = [name, url, options];
